...
public class MainActivity extends Activity implements OnClickListener {
    ...
    /*private void updateAccel() {
        ...
        TextView uwu = (TextView)findViewById(R.id.uwu);
        uwu.setText(String.format("fff"));
    ...
    private void updateEeg() {
        ...
        Double avgeegd = eegBuffer[0] + eegBuffer[1] + eegBuffer[2] + eegBuffer[3];
        String avgeeg = avgeegd.toString();

        remoteControl(avgeegd, avgeeg);
    }

   /* private void updateAlpha() {
           String eeg1 = eeg1d.toString();
        String eeg2 = eeg2d.toString();
        String eeg3 = eeg3d.toString();
    ...
    public int alt = 0;
    private void remoteControl(Double avgeegd, String avgeeg) {
        /*Toast toast = Toast.makeText(getApplicationContext(),"avgeeg=" + avgeeg,Toast.LENGTH_SHORT);
        toast.show();*/
        ImageView colourer = (ImageView) findViewById(R.id.colourer);

        if (avgeegd <= 3200 && alt < 300) {
            alt = alt + 1;
            colourer.setImageResource(R.drawable.up);
            ...
            colourer.setImageResource(R.drawable.down);
